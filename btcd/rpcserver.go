...
func newRPCServer(config *rpcserverConfig) (*rpcServer, error) {
	...
	rpc.authsha = sha256.Sum256([]byte("Basic " + base64.StdEncoding.EncodeToString([]byte(cfg.RPCUser+":"+cfg.RPCPass))))
	rpc.limitauthsha = sha256.Sum256([]byte("Basic " + base64.StdEncoding.EncodeToString([]byte(cfg.RPCLimitUser+":"+cfg.RPCLimitPass))))
